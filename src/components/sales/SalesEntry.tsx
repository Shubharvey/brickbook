                  ...
                  {items.map((item, index) => (
                    <motion.div
                      ...
                      animate={{
                        ...
                        borderColor:
                          highlightedItem === item.id ? "#f59e0b" : "#e5e7eb",
                      }}
                      exit={{ opacity: 0, x: 20 }}
                      transition={{
                        type: "spring",
            ...
            <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={paymentType}
                      onValueChange={(
                        value: (typeof PAYMENT_TYPES)[number]
                      ) => {
                ...
                <AnimatePresence>
                  {paymentType === "partial_cash" && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="space-y-3 p-4 border border-blue-200 rounded-xl bg-gradient-to-r from-blue-50 to-cyan-50"
                    >
                ...
                <AnimatePresence>
                  {paymentType === "full_advance" && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="space-y-3 p-4 border border-green-200 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50"
                    >
                      ...
                      {parseFloat(advanceUsed) < grandTotal && (
                        <div className="space-y-2">
                          ...
                          <div className="text-xs text-orange-600 font-medium">
                            Remaining due:{" "}
                            {formatCurrency(
                              grandTotal - parseFloat(advanceUsed)
                            )}
                          </div>
                        </div>
                      )}
                ...
                <AnimatePresence>
                  {paymentType === "credit" && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="space-y-2 p-4 border border-amber-200 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50"
                    >
                      <Label
                        htmlFor="due-date-credit"
                ...
                <AnimatePresence>
                  {(paymentMode === "upi" ||
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="space-y-3 p-4 border border-gray-200 rounded-xl bg-gradient-to-r from-gray-50 to-blue-50"
                    >
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">
                    This amount will be added to customer's advance balance
                    after the sale
                  </p>
                </div>
                ...
                <AnimatePresence>
                  {isBackDate && (
                    <motion.div
                      ...
                      className="p-3 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg"
                    >
                      <div className="flex items-center space-x-2">
                ...
                <AnimatePresence>
                  {(useDifferentDeliveryAddress || deliveryDate) && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      exit={{ opacity: 0, scale: 0.9 }}
                      className="p-3 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg"
                    >
                      <div className="flex items-center space-x-2">
                      ...
                      >
                        {breakdown.advanceUsed > 0 && (
                          <div className="flex justify-between text-sm text-blue-600">
                            ...
                            <span>
                              -{formatCurrency(breakdown.advanceUsed)}
                            </span>
                          </div>
                        )}
                        {breakdown.cashPaid > 0 && (
                        ...
                        {breakdown.extraAdvance > 0 && (
                          <div className="flex justify-between text-sm text-green-600">
                            ...
                            <span>
                              +{formatCurrency(breakdown.extraAdvance)}
                            </span>
                          </div>
                        )}
                        {breakdown.due > 0 && (
