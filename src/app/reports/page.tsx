...
// Simple loading component (moved inline)
...
// Lazy load the heavy ReportsManagement component
const ReportsManagement = dynamic(
  () => import("../../components/reports/ReportsManagement"),
  {
    loading: () => <LoadingFallback />,
    // Removed ssr: false since this is a Server Component
  }
);
